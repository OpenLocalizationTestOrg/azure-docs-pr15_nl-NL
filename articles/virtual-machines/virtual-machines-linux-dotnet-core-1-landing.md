...
De sjabloon muziek Store resourcemanager vindt u hier, [Muziek Store Linux-sjabloon]( https://github.com/neilpeterson/nepeters-azure-templates/tree/master/dotnet-core-music-linux-vm-sql-db)
...
- [**Beschikbaarheid en schaal**](./virtual-machines-linux-dotnet-core-4-availability-scale.md) – beschikbaarheid en schaal verwijzen naar de mogelijkheid toepassingen om te blijven uitvoeren tijdens infrastructuur downtime en de mogelijkheid om te berekenen resources om te voldoen aan de toepassing aanvraag schaal. Deze documentgegevens de onderdelen die nodig zijn om te implementeren van een taakverdeling en maximaal beschikbare toepassing.

- [**Implementatie van toepassing**](./virtual-machines-linux-dotnet-core-5-app-deployment.md) - bij de implementatie van toepassingen naar Azure virtuele Machines, de methode waarmee de binaire bestanden van toepassing zijn geïnstalleerd op de virtuele Machine moet worden beschouwd. In dit document details automatiseren toepassingsinstallatie met behulp van Azure virtuele machines aangepast scriptextensies.
...
|---|---|
|SSHKEYDATA   | SSH belangrijke gegevens gebruikt om te beveiligen toegang tot de virtuele Machine. Zie voor informatie over het maken van een combinatie van SSH-sleutel [maken SSH toetsen voor Linux VMs in Azure wordt aangegeven](virtual-machines-linux-mac-create-ssh-keys.md).  |
|ADMINUSERNAME   | Beheerder-gebruikersnaam die wordt gebruikt in de virtuele machine en de Azure SQL-Database.  |
|SQLADMINPASSWORD | Wachtwoord dat wordt gebruikt in de Azure SQL-Database.  |
...
[Stap 1: toepassingsarchitectuur met Azure resourcemanager-sjablonen](./virtual-machines-linux-dotnet-core-2-architecture.md)
