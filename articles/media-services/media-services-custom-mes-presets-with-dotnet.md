<properties 
    pageTitle="Geavanceerde coderen met Media Encoder Standard | Microsoft Azure" 
...
>[AZURE.NOTE]De instelling **SceneChangeDetection** in alleen de volgende vooraf ingestelde kunnen worden ingesteld op waar als u naar een video één bitsnelheid worden gecodeerd. Als u naar een video multi-bitrate worden gecodeerd en **SceneChangeDetection** ingesteld op waar, kunnen de encoder een fout zullen retourneren.  
...
>
>Uw bron-videobestand en de overlay-bestand moeten zich in dezelfde activa.
