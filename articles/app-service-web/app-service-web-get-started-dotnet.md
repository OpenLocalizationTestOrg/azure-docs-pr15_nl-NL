...
Deze zelfstudie kunt u een eenvoudige .NET-WebApp implementeren naar [Azure App-Service](../app-service/app-service-value-prop-what-is.md).
...
- Voorbeeld ASP.NET-code implementeren.
...
## <a name="deploy-an-net-web-app"></a>Een .NET-web-app implementeren
...
1. Wijzigen in een werkmap (`CD`) en de app steekproef klonen.
...
4. Maak de App Service app resource in Azure wordt aangegeven met de naam van een unieke app en de implementatie-gebruiker die u eerder hebt geconfigureerd. Wanneer u wordt gevraagd, geeft u het aantal het gewenste gebied.
    ...
    ![Maken van de Azure resource voor de eerste WebApp in Azure wordt aangegeven](./media/app-service-web-get-started-languages/dotnet-site-create.png)
...
4. Uw voorbeeldcode dashboard implementeren naar uw Azure-app zoals u zou push-code met cijfer. Wanneer u wordt gevraagd, gebruikt u het wachtwoord dat u eerder hebt geconfigureerd.
    ...
    ![Push-code bij uw eerste web-app in Azure wordt aangegeven](./media/app-service-web-get-started-languages/dotnet-git-push.png)

    `git push`niet alleen voegt het code in Azure wordt aangegeven, maar ook herstelt u de vereiste pakketten en bouwt de ASP.NET binaire bestanden. 
...
Informatie over het maken en implementeren van .NET-WebApps naar Azure rechtstreeks in Visual Studio op [Deploy een ASP.NET-web-app Azure App-service, met behulp van Visual Studio](web-sites-dotnet-get-started.md)ontwikkelen.
