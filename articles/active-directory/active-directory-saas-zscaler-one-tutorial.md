...
###<a name="to-assign-users-to-zscaler-one-perform-the-following-steps"></a>Als u wilt toewijzen aan gebruikers aan één ZScaler, moet u de volgende stappen uitvoeren:
