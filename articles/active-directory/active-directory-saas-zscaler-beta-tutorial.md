...
###<a name="to-assign-users-to-zscaler-beta-perform-the-following-steps"></a>Als u wilt gebruikers toewijzen aan ZScaler Beta, moet u de volgende stappen uitvoeren:
