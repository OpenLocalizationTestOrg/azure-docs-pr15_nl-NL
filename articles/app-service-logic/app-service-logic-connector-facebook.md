<properties
   pageTitle="Gebruik van de Facebook-Connector in logica Apps | Microsoft Azure-App-Service"
   description="Het maken en configureren van de Facebook-Connector of API-app en deze gebruiken in een app logica in Azure App-Service"
   services="logic-apps"
...
# <a name="weve-improved-the-facebook-connector"></a>We hebt de Facebook-connector verbeterd 
...
- [Meer informatie over deze nieuwe verbindingslijn](../connectors/connectors-create-api-facebook.md)
