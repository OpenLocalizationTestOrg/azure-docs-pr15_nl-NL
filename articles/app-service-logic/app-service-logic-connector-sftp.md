<properties
    pageTitle="Gebruik van de verbindingslijn SFTP in logica Apps | Microsoft Azure-App-Service"
    description="Het maken en configureren van de app SFTP verbindingslijn of API en deze gebruiken in een app logica in Azure App-Service"
    authors="msftman"
    manager="erikre"
    editor=""
    services="logic-apps"
...
# <a name="weve-improved-the-sftp-connector"></a>We hebt de verbindingslijn SFTP verbeterd 
