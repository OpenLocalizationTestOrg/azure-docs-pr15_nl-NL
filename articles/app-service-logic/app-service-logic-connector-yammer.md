<properties
   pageTitle="Gebruik van de Yammer-Connector in logica Apps | Microsoft Azure-App-Service"
   description="Het maken en configureren van de Yammer-verbindingslijn of API-app en deze gebruiken in een app logica in Azure App-Service"
   services="logic-apps"
...
# <a name="weve-improved-the-yammer-connector"></a>We hebt de Yammer-connector verbeterd 
