<properties 
    pageTitle="Gebruik van de toegestane vertraging verbindingslijn in logica Apps | Microsoft Azure-App-Service"
    description="Het maken en configureren van de marge verbindingslijn of API-app en deze gebruiken in een app logica in Azure App-Service"
    authors="msftman" 
    manager="erikre" 
    editor="" 
    services="logic-apps" 
...
# <a name="weve-improved-the-slack-connector"></a>We hebt de toegestane vertraging verbindingslijn verbeterd 
...
- [Meer informatie over deze nieuwe verbindingslijn](../connectors/connectors-create-api-slack.md)
