...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>SQL Data Warehouse dynamische management weergaven (DMVs)
...
## <a name="sql-server-dmvs-applicable-to-sql-data-warehouse"></a>SQL Server DMVs van toepassing op SQL Data Warehouse

De volgende DMVs zijn van toepassing op SQL Data Warehouse, maar moeten worden uitgevoerd door de verbinding maken met **de hoofddatabase** .

- [sys.database_service_objectives](https://msdn.microsoft.com/library/mt712619.aspx)
- [sys.dm_operation_status](https://msdn.microsoft.com/library/dn270022.aspx)
- [sys.fn_helpcollations()](https://msdn.microsoft.com/library/ms187963.aspx)

## <a name="sql-server-catalog-views"></a>Weergaven voor SQL Server-catalogus
...
SQL Data Warehouse biedt veel van de SQL Server management dynamische weergaven (DMVs). Deze weergaven, wanneer de query wordt uitgevoerd in SQL Data Warehouse, zijn de status van de SQL-Databases die zijn uitgevoerd op de onderzoeken rapportage.

Aangezien SQL Data Warehouse is gebaseerd op Microsofts MPP-technologie en de dezelfde systeemweergaven gebruiken in SQL Data Warehouse zowel Platform analysesysteem van Parallel Data Warehouse (PDW).

Daarom elk van de volgende DMV heeft een specifieke kolom pdw_node_id genoemd. Dit is de de id voor het knooppunt berekeningscluster. In de berekeningscluster PDW is knooppunt een sterker concept voor de architectuur. In SQL Data Warehouse, de architectuur meer is sterk afhankelijk van de onderzoeken.

>[AZURE.NOTE] Als u wilt gebruiken in deze weergave, plaats u 'pdw_nodes_' in de naam van de zoals wordt weergegeven in de volgende tabel.


| De naam van de DMV in SQL Data Warehouse | Koppeling naar SQL Server Transact-SQL-onderwerp op MSDN |
| :----------------------------- | :-------------------------------------------- |
