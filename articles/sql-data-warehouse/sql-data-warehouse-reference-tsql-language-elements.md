<properties
   pageTitle="Elementen van de SQL Data Warehouse Transact-SQL-taal | Microsoft Azure"
   description="Lijst met koppelingen naar naslaginformatie voor de Transact-SQL-taal-elementen die wordt gebruikt voor SQL Data Warehouse."
...
# <a name="language-elements"></a>Elementen van de taal

## <a name="core-elements"></a>Core-elementen

- [syntaxis van de conventies](https://msdn.microsoft.com/library/ms177563.aspx)
- [regels voor naamgeving van object](https://msdn.microsoft.com/library/ms175874.aspx)
- [gereserveerde sleutelwoorden](https://msdn.microsoft.com/library/ms189822.aspx)
...
- [Tijdelijke oplossing identiteit-eigenschap](https://msdn.microsoft.com/library/ms186775.aspx)
- [AFDRUKKEN](https://msdn.microsoft.com/library/ms176047.aspx)
- [GEBRUIK](https://msdn.microsoft.com/library/ms188366.aspx)

## <a name="batches-control-of-flow-and-variables"></a>Batches van besturingsstroom en variabelen

- [BEGIN... EINDE](https://msdn.microsoft.com/library/ms190487.aspx)
- [EINDE](https://msdn.microsoft.com/library/ms181271.aspx)
- [DECLAREREN@local_variable](https://msdn.microsoft.com/library/ms188927.aspx)
- [ALS... NOG MEER](https://msdn.microsoft.com/library/ms182717.aspx)
...
- [PROBEER: VARIABEL](https://msdn.microsoft.com/library/ms175976.aspx)
- [TIJD](https://msdn.microsoft.com/library/ms178642.aspx)

## <a name="operators"></a>Operatoren
- [+ (Toevoegen)](https://msdn.microsoft.com/library/ms178565.aspx)
- [+ (Tekenreeks samenvoeging)](https://msdn.microsoft.com/library/ms177561.aspx)
- [-(Negatieve getallen)](https://msdn.microsoft.com/library/ms189480.aspx)
...
## <a name="wildcard-characters-to-match"></a>Jokertekens tekens om aan te passen
- [= (Is gelijk aan)](https://msdn.microsoft.com/library/ms175118.aspx)
- [> (Groter dan)](https://msdn.microsoft.com/library/ms178590.aspx)
- [< (Kleiner dan)](https://msdn.microsoft.com/library/ms179873.aspx)
- [> = (fraai dan of gelijk aan)](https://msdn.microsoft.com/library/ms181567.aspx)
...
- [VIND IK LEUK](https://msdn.microsoft.com/library/ms179859.aspx)
- [NIET](https://msdn.microsoft.com/library/ms189455.aspx)
- [OF-BEWERKING](https://msdn.microsoft.com/library/ms188361.aspx)
...
- [^ (Bitsgewijze exclusieve OR)](https://msdn.microsoft.com/library/ms190277.aspx)
- [~ (Bitsgewijze niet)](https://msdn.microsoft.com/library/ms173468.aspx)
- [^ = (Bitsgewijze exclusieve of is gelijk aan)](https://msdn.microsoft.com/library/cc627413.aspx)
- [| = (Bitsgewijze of-bewerking is gelijk aan)](https://msdn.microsoft.com/library/cc627409.aspx)
...
- [BOOGSIN](https://msdn.microsoft.com/library/ms181581.aspx)
...
- [FUNCTIE DATEFROMPARTS](https://msdn.microsoft.com/library/hh213228.aspx)
...
- [VERTRAGINGS](https://msdn.microsoft.com/library/hh231256.aspx)
- [LAST_VALUE](https://msdn.microsoft.com/library/hh231517.aspx)
- [POTENTIËLE KLANT](https://msdn.microsoft.com/library/hh213125.aspx)
- [LINKS](https://msdn.microsoft.com/library/ms177601.aspx)
- [LENGTE](https://msdn.microsoft.com/library/ms190329.aspx)
...
- [DE FUNCTIES LTRIM](https://msdn.microsoft.com/library/ms177827.aspx)
...
- [VIA component](https://msdn.microsoft.com/library/ms189461.aspx)
...
- [ASELECT](https://msdn.microsoft.com/library/ms177610.aspx)
...
- [AANMELDEN](https://msdn.microsoft.com/library/ms188420.aspx)
...
- [ITEMS](https://msdn.microsoft.com/library/ms188043.aspx)
- [SUBTEKENREEKS](https://msdn.microsoft.com/library/ms187748.aspx)
...
- [HOOFDLETTERS](https://msdn.microsoft.com/library/ms180055.aspx)
...
## <a name="diagnostic-sessions"></a>Sessies met diagnostische gegevens

- [DIAGNOSTISCH HULPPROGRAMMA SESSIE MAKEN](https://msdn.microsoft.com/library/mt204029.aspx)
...
- [ANSI_DEFAULTS INSTELLEN](https://msdn.microsoft.com/library/ms188340.aspx)
- [ANSI_NULL_DFLT_OFF INSTELLEN](https://msdn.microsoft.com/library/ms187356.aspx)
- [ANSI_NULL_DFLT_ON INSTELLEN](https://msdn.microsoft.com/library/ms187375.aspx)
...
- [DE DATUMNOTATIE INSTELLEN](https://msdn.microsoft.com/library/ms189491.aspx)
- [FMTONLY INSTELLEN](https://msdn.microsoft.com/library/ms173839.aspx)
- [IMPLICIT_TRANSACITONS INSTELLEN](https://msdn.microsoft.com/library/ms187807.aspx)
- [LOCK_TIMEOUT INSTELLEN](https://msdn.microsoft.com/library/ms189470.aspx)
- [NUMBERIC_ROUNDABORT INSTELLEN](https://msdn.microsoft.com/library/ms188791.aspx)
- [QUOTED_IDENTIFIER INSTELLEN](https://msdn.microsoft.com/library/ms174393.aspx)
- [AANTAL RIJEN INSTELLEN](https://msdn.microsoft.com/library/ms188774.aspx)
