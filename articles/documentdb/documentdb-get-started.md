...
Kopieer en plak de volgende code naar uw **GetStartedDemo** methode onder het maken van de database. Hiermee maakt u een documentverzameling met de naam *FamilyCollection_oa*.
