<properties 
   pageTitle="Een VM met een statische openbare IP-gebruik van de Azure CLI in resourcemanager implementeren | Microsoft Azure"
   description="Informatie over het implementeren van VMs met een statische openbare IP-gebruik van de Azure CLI in resourcemanager"
...
# <a name="deploy-a-vm-with-a-static-public-ip-using-the-azure-cli"></a>Een VM met een statische openbare IP-gebruik van de Azure CLI implementeren
...
4. De netwerkinterface (NIC) voor de VM in de bovenstaande gemaakt met het openbare IP-subnetten maken. Kennisgeving de eerste reeks opdrachten worden gebruikt voor het ophalen van de **Id** van het subnet hiervoor hebt gemaakt.
...
1. Vanuit een console we vaker doen, moet u de bovenstaande script uitvoeren.
