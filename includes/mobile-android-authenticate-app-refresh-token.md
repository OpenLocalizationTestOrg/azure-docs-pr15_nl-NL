...
2. De volgende leden toevoegen de `ToDoActivity` class. 
    ...
    Deze worden gebruikt om te synchroniseren van de verificatie van de gebruiker. Alleen willen we eenmaal verifiëren. Eventuele aanroepen tijdens verificatie moeten wachten en gebruikt het nieuwe token van de verificatie in voortgang.
